...
public class Grafica<T> implements Coleccion<T> {
    ...
    private Vecino buscaVecino(Vertice vertice,
                               Vertice vecino) {
        return vertice.vecinos.get(vecino.elemento);
    }
    ...
    @Override public void agrega(T elemento) {
        if (elemento == null || contiene(elemento))
            ...
            this.vertices.agrega(elemento, new Vertice(elemento));
    }
    ...
    public void conecta(T a, T b, double peso) {
        if (sonVecinos(a, b) || a.equals(b) || peso < 1) {
            throw new IllegalArgumentException("Los elementos ya estan cone" +
                                                "ctados o son iguales");
        } else {
            Grafica<T>.Vertice v1 = buscaVertice(a);
    ...
    public void desconecta(T a, T b) {
        ...
        if (sonVecinos(a, b)) {
            verA.vecinos.elimina(b);
            verB.vecinos.elimina(a);
            aristas--;
        } else
    ...
    @Override public void elimina(T elemento) {
        Vertice aux = vertices.get(elemento);
        for (Vecino e : aux.vecinos) {
            e.vecino.vecinos.elimina(elemento);
            aristas--;
        }
    ...
    public double getPeso(T a, T b) {
        if (!sonVecinos(a, b))
            ...
            Vertice aux = buscaVertice(a);
            Vertice vecino = buscaVertice(b);
            return buscaVecino(aux, vecino).peso;
        }
    }
